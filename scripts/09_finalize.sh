...
echo -e "${COLOR_BOLD_GREEN}║       Copia y guarda toda esta información ahora             ║${COLOR_RESET}"
echo -e "${COLOR_BOLD_GREEN}╠══════════════════════════════════════════════════════════════╣${COLOR_RESET}"
echo -e "${COLOR_BOLD_GREEN}║                                                              ║${COLOR_RESET}"
echo -e "${COLOR_BOLD_GREEN}║  ${COLOR_BOLD_WHITE}ACCESO SSH${COLOR_RESET}                                                ${COLOR_BOLD_GREEN}║${COLOR_RESET}"
echo -e "${COLOR_BOLD_GREEN}║                                                              ║${COLOR_RESET}"
echo -e "${COLOR_BOLD_GREEN}║  ${COLOR_WHITE}Comando:${COLOR_RESET}  ${COLOR_CYAN}ssh -i vpsfacil_key.pem ${ADMIN_USER}@${TS_IP}${COLOR_RESET}"
echo -e "${COLOR_BOLD_GREEN}║  ${COLOR_WHITE}Usuario:${COLOR_RESET}  ${COLOR_CYAN}${ADMIN_USER}${COLOR_RESET}"
echo -e "${COLOR_BOLD_GREEN}║  ${COLOR_WHITE}IP VPN:${COLOR_RESET}   ${COLOR_CYAN}${TS_IP}${COLOR_RESET}"
echo -e "${COLOR_BOLD_GREEN}║  ${COLOR_WHITE}Clave:${COLOR_RESET}    ${COLOR_CYAN}${ADMIN_HOME}/.ssh/id_ed25519  (ya copiada arriba)${COLOR_RESET}"
echo -e "${COLOR_BOLD_GREEN}║                                                              ║${COLOR_RESET}"
echo -e "${COLOR_BOLD_GREEN}╠══════════════════════════════════════════════════════════════╣${COLOR_RESET}"
echo -e "${COLOR_BOLD_GREEN}║                                                              ║${COLOR_RESET}"
echo -e "${COLOR_BOLD_GREEN}║  ${COLOR_BOLD_WHITE}FILE BROWSER${COLOR_RESET}  ${COLOR_YELLOW}(Explorador de archivos web)${COLOR_RESET}              ${COLOR_BOLD_GREEN}║${COLOR_RESET}"
echo -e "${COLOR_BOLD_GREEN}║                                                              ║${COLOR_RESET}"
echo -e "${COLOR_BOLD_GREEN}║  ${COLOR_WHITE}URL:${COLOR_RESET}          ${COLOR_CYAN}${URL_FILEBROWSER}${COLOR_RESET}"
echo -e "${COLOR_BOLD_GREEN}║  ${COLOR_WHITE}Usuario:${COLOR_RESET}      ${COLOR_CYAN}${ADMIN_USER}${COLOR_RESET}"
echo -e "${COLOR_BOLD_GREEN}║  ${COLOR_WHITE}Contraseña:${COLOR_RESET}   ${COLOR_CYAN}${ADMIN_PASSWORD}${COLOR_RESET}"
echo -e "${COLOR_BOLD_GREEN}║                                                              ║${COLOR_RESET}"
echo -e "${COLOR_BOLD_GREEN}╠══════════════════════════════════════════════════════════════╣${COLOR_RESET}"
echo -e "${COLOR_BOLD_GREEN}║                                                              ║${COLOR_RESET}"
echo -e "${COLOR_BOLD_GREEN}║  ${COLOR_BOLD_WHITE}KOPIA BACKUP${COLOR_RESET}  ${COLOR_YELLOW}(Backups cifrados)${COLOR_RESET}                        ${COLOR_BOLD_GREEN}║${COLOR_RESET}"
echo -e "${COLOR_BOLD_GREEN}║                                                              ║${COLOR_RESET}"
echo -e "${COLOR_BOLD_GREEN}║  ${COLOR_WHITE}URL web:${COLOR_RESET}      ${COLOR_CYAN}${URL_KOPIA}${COLOR_RESET}"
...
echo -e "${COLOR_BOLD_GREEN}║                                                              ║${COLOR_RESET}"
echo -e "${COLOR_BOLD_GREEN}║  ${COLOR_YELLOW}KopiaUI Desktop (conexión directa por Tailscale):${COLOR_RESET}          ${COLOR_BOLD_GREEN}║${COLOR_RESET}"
echo -e "${COLOR_BOLD_GREEN}║  ${COLOR_WHITE}URL gRPC:${COLOR_RESET}     ${COLOR_CYAN}grpc://${TS_IP}:51515${COLOR_RESET}"
echo -e "${COLOR_BOLD_GREEN}║  ${COLOR_WHITE}Usuario:${COLOR_RESET}      ${COLOR_CYAN}${ADMIN_USER}${COLOR_RESET}"
echo -e "${COLOR_BOLD_GREEN}║  ${COLOR_WHITE}Contraseña:${COLOR_RESET}   ${COLOR_CYAN}${ADMIN_PASSWORD}${COLOR_RESET}"
echo -e "${COLOR_BOLD_GREEN}║                                                              ║${COLOR_RESET}"
echo -e "${COLOR_BOLD_GREEN}╠══════════════════════════════════════════════════════════════╣${COLOR_RESET}"
echo -e "${COLOR_BOLD_GREEN}║                                                              ║${COLOR_RESET}"
echo -e "${COLOR_BOLD_GREEN}║  ${COLOR_BOLD_WHITE}BESZEL HUB${COLOR_RESET}  ${COLOR_YELLOW}(Monitoreo del servidor)${COLOR_RESET}                  ${COLOR_BOLD_GREEN}║${COLOR_RESET}"
echo -e "${COLOR_BOLD_GREEN}║                                                              ║${COLOR_RESET}"
echo -e "${COLOR_BOLD_GREEN}║  ${COLOR_WHITE}URL:${COLOR_RESET}          ${COLOR_CYAN}${URL_BESZEL}${COLOR_RESET}"
echo -e "${COLOR_BOLD_GREEN}║  ${COLOR_WHITE}Email:${COLOR_RESET}        ${COLOR_CYAN}${ADMIN_USER}@${DOMAIN}${COLOR_RESET}"
echo -e "${COLOR_BOLD_GREEN}║  ${COLOR_WHITE}Contraseña:${COLOR_RESET}   ${COLOR_CYAN}${ADMIN_PASSWORD}${COLOR_RESET}"
echo -e "${COLOR_BOLD_GREEN}║                                                              ║${COLOR_RESET}"
echo -e "${COLOR_BOLD_GREEN}╠══════════════════════════════════════════════════════════════╣${COLOR_RESET}"
echo -e "${COLOR_BOLD_GREEN}║                                                              ║${COLOR_RESET}"
echo -e "${COLOR_BOLD_GREEN}║  ${COLOR_BOLD_WHITE}REQUISITO DE ACCESO${COLOR_RESET}                                       ${COLOR_BOLD_GREEN}║${COLOR_RESET}"
echo -e "${COLOR_BOLD_GREEN}║                                                              ║${COLOR_RESET}"
echo -e "${COLOR_BOLD_GREEN}║  ${COLOR_YELLOW}Debes tener Tailscale activo en tu PC para acceder${COLOR_RESET}         ${COLOR_BOLD_GREEN}║${COLOR_RESET}"
echo -e "${COLOR_BOLD_GREEN}║  ${COLOR_YELLOW}a cualquiera de las URLs de arriba.${COLOR_RESET}                        ${COLOR_BOLD_GREEN}║${COLOR_RESET}"
echo -e "${COLOR_BOLD_GREEN}║  ${COLOR_WHITE}Descarga: https://tailscale.com/download${COLOR_RESET}                   ${COLOR_BOLD_GREEN}║${COLOR_RESET}"
echo -e "${COLOR_BOLD_GREEN}║                                                              ║${COLOR_RESET}"
echo -e "${COLOR_BOLD_GREEN}╚══════════════════════════════════════════════════════════════╝${COLOR_RESET}"
echo ""
