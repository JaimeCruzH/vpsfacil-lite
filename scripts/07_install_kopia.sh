...
log_info "  Usuario UI:         ${ADMIN_USER}"
log_info "  Contraseña UI:      (la que configuraste al inicio)"
log_info "  Contraseña cifrado: (la misma contraseña admin)"
log_info "  Repositorio local:  ${BACKUP_DIR}"
